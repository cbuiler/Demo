...
//	private final String TAG = PullRefreshListView.class.getSimpleName();
    ...
    private void init(Context context) {
        ...
        mHeadView = (LinearLayout) inflater.inflate(R.layout.framework_pull_refresh_head,
                this, false);
//        mHeadView.setTag(PULL_REFRESH_TAG);
        ...
        mLoadMoreView = (RelativeLayout) inflater.inflate(
                R.layout.framework_pull_refresh_load_more, this, false);
        ...
        measureView(mLoadMoreView);                // 测量视图
...
//					System.out.println("在down时候记录当前位置‘");
                    }
                    break;
    ...
    private void changeHeaderViewByState(boolean useAnimation) {
        ...
        switch (mState) {
            case RELEASE_To_REFRESH:
                ...
                mHeadTipsTextview.setText(R.string.framework_pull_refresh_loosen_refresh);
            ...
            case PULL_To_REFRESH:
                ...
                if (mIsBack) {
                    ...
                    mHeadTipsTextview.setText(R.string.framework_pull_refresh_pull_down_refresh);
                } else {
                    mHeadTipsTextview.setText(R.string.framework_pull_refresh_pull_down_refresh);
                }
                break;
            ...
            case REFRESHING:
                ...
                mHeadTipsTextview.setText(R.string.framework_pull_refresh_refreshing);
                mHeadLastUpdatedTextView.setVisibility(View.VISIBLE);
            ...
            default:
                ...
                mHeadprogressBar.setVisibility(View.GONE);
                mHeadArrowImageView.clearAnimation();
                mHeadArrowImageView.setImageResource(R.drawable.framework_arrow_refresh_down);
                mHeadTipsTextview.setText(R.string.framework_pull_refresh_pull_down_refresh);
                mHeadLastUpdatedTextView.setVisibility(View.VISIBLE);
    ...
    private void changeLoadMoreViewByState() {
        switch (mState) {
            case LOADING_MORE: {
                ...
                mLoadMoreTipTextView.setText(R.string.framework_pull_refresh_loading);
                break;
            }
            default:
                if (mCanLoadMore) {
                    ...
                    mLoadMoreTipTextView.setText(R.string.framework_pull_refresh_load_more);
                } else {
    ...
    public void setRefreshTime(Date date) {
        if (date != null) {
            ...
            String format = getContext().getString(R.string.framework_pull_refresh_last_updated);
            mHeadLastUpdatedTextView.setText(String.format(format, time));
        } else {
