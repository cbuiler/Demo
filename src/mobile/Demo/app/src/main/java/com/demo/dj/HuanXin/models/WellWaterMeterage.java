...
import com.demo.dj.HuanXin.beans.WellWaterMeterageBean;
 ...
 */
public class WellWaterMeterage extends ModelBase {
    private String JSON_PROTOCOL_VALUE = "HXCB_UP_0303";

    private DBManager mDbManager;
    private Context context;

    private ArrayList<WellWaterMeterageBean> data = new ArrayList<WellWaterMeterageBean>();
    ...
    public String buildRequest() throws JSONException {
        ...
        for (int i=0; i<data.size(); i++) {
            WellWaterMeterageBean item = data.get(i);
